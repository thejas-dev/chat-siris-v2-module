...
// Local dev / Render (`node dist/index.js`): start the listener + pub/sub subscriber.
// On Vercel the module is imported (require.main !== module), so this is skipped and
// the default-exported app is served instead — the subscriber does not run serverless.
